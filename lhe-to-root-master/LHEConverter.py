...
def main():
    ...
    my_tree = TTree('lheTree','tree of generated events')
    ...
    my_tree.Branch('pdgID',pdg_id)
    my_tree.Branch('status',status)
    my_tree.Branch('mother1',mother1)
    my_tree.Branch('mother2',mother2)
    my_tree.Branch('color1',color1)
    my_tree.Branch('color2',color2)
    my_tree.Branch('px',px)
    my_tree.Branch('py',py)
    my_tree.Branch('pz',pz)
    my_tree.Branch('e',e)
    my_tree.Branch('m',m)
        ...
        for line in input_file:
            ...
            if is_event and is_meta:
                ...
                if len(data) != 13:
                    ...
                    pdg_id.push_back(int(data[0]))
                    status.push_back(int(data[1]))
                    mother1.push_back(int(data[2]))
                    mother2.push_back(int(data[3]))
                    color1.push_back(int(data[4]))
                    color2.push_back(int(data[5]))
                    px.push_back(data[6])
                    py.push_back(data[7])
                    pz.push_back(data[8])
                    e.push_back(data[9])
